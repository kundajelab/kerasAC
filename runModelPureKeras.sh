...
CUDA_VISIBLE_DEVICES=7 python runModelPureKeras.py --train_path /srv/scratch/annashch/deeplearning/form_inputs/gecco_inputs_v2/experiments_easy_set/tasks_for_difficult_tfs/multi_task.train.bed \
...
CUDA_VISIBLE_DEVICES=3 python runModelPureKeras.py --train_path /srv/scratch/annashch/deeplearning/form_inputs/gecco_inputs_v2/experiments_easy_set/tasks_for_difficult_tfs/multi_task.train.bed \
		    --valid_path /srv/scratch/annashch/deeplearning/form_inputs/gecco_inputs_v2/experiments_easy_set/tasks_for_difficult_tfs/multi_task.validate.bed \
...
#CUDA_VISIBLE_DEVICES=7 python runModelPureKeras.py --train_path /srv/scratch/annashch/deeplearning/form_inputs/gecco_inputs_v2/experiments_easy_set/gc.1.fp_control.shuffled.bed \
...
#
#
#CUDA_VISIBLE_DEVICES=3 python runModelPureKeras.py --train_path /srv/scratch/annashch/deeplearning/form_inputs/gecco_inputs_v2/experiments_easy_set/gc.1.fp_control.shuffled.bed \
#		    --valid_path /srv/scratch/annashch/deeplearning/form_inputs/gecco_inputs_v2/experiments_easy_set/easy.V576.gc.1.neg.1pos.validate.bed \
...
#
#
#CUDA_VISIBLE_DEVICES=3 python runModelPureKeras.py --train_path /srv/scratch/annashch/deeplearning/form_inputs/gecco_inputs_v2/archive/single.train.28.bed \
...
#
#
#CUDA_VISIBLE_DEVICES=1 python runModelPureKeras.py --train_path /srv/scratch/annashch/deeplearning/form_inputs/gecco_inputs_v2/experiments_negative_set/V576_DNase.train.bed \
...
#
#
#CUDA_VISIBLE_DEVICES=7 python runModelPureKeras.py --train_path /srv/scratch/annashch/deeplearning/form_inputs/gecco_inputs_v2/experiments_easy_set/easy.V576.gc.1.neg.1pos.train.bed \
#		    --valid_path /srv/scratch/annashch/deeplearning/form_inputs/gecco_inputs_v2/experiments_easy_set/easy.V576.gc.1.neg.1pos.validate.bed \
...
#
#
#CUDA_VISIBLE_DEVICES=7 python runModelPureKeras.py --train_path /srv/scratch/annashch/deeplearning/form_inputs/gecco_inputs_v2/experiments_easy_set/easy.V576.gc.5.neg.1pos.train.bed \
...
#
#
#CUDA_VISIBLE_DEVICES=7 python runModelPureKeras.py --train_path /srv/scratch/annashch/deeplearning/form_inputs/gecco_inputs_v2/experiments_easy_set/easy.V576.dinuc.1neg.1pos.train.bed \
...
#
#
#CUDA_VISIBLE_DEVICES=0 python runModelPureKeras.py --train_path /srv/scratch/annashch/deeplearning/form_inputs/gecco_inputs_v2/experiments_easy_set/easy.V576.dinuc.5.neg.1pos.train.bed \
