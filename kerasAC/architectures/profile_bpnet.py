...
def getModelGivenModelOptionsAndWeightInits(args):
    ...
    for i in range(1, n_dil_layers + 1):
        if i == 1:
            ...
            res_layers_sum = Add([l for l, _ in res_layers],
                                 name='add_{}'.format(i))
    ...
    combined_conv = Add([l for l, _ in res_layers],
                        name='combined_conv') 
    ...
    model=Model(input=[inp],outputs=[profile_out,
                                     count_out])
...
if __name__=="__main__":
    ...
    parser.add_argument("--tdb_input_flank",nargs="+",default=[500])
