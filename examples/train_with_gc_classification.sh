#caprin is chrom 11,
#we  use split #7
CUDA_VISIBLE_DEVICES=0 kerasAC_train --index_data_path K562.encode4crispr.classificationlabels.SummitWithin200bpCenter.hdf5 \
		    ...
		    --num_inputs 2 \
		    --num_outputs 1 \
		    --model_hdf5 DNASE.K562.classificationlabels.7.withgc \
		    ...
		    --architecture_from_file functional_basset_classification_gc_corrected.py \
		    --num_train 10000000 \
		    --num_valid 1000000 \
		    --num_tasks 1 \
		    --threads 10 \
